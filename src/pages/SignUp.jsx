...
function SignUp() {
  ...
  return (
    ...
    <form className='w-[90%] h-[450px] max-w-[500px] bg-[#00000000] backdrop-blur shadow-lg shadow-blue-850 -translate-y-10 flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
        ...
        <button className='min-w-[150px] h-[60px] bg-white rounded-full mt-[30px] text-black font-semibold text-[19px]' disabled = {loading}> {loading ? "Signing Up..." : "Sign Up"}
